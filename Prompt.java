public class Prompt implements MadjickSarapInterface
{
  public void prompt(String filepath, String output, int value)
  { 
    ...
    if (filepath.equals("--help"))
    {
      //User will be shown how to use the program
      menu.help();
    }
    else if(filepath.equals("--about"))
    {
    ...
    //BlackAndWhite
    else if (filepath.equals("BlackAndWhite") && output.equals(args[1]) && args[2].equals(args[2]))
    {
      //Commented this out
